...
class Settings extends PureComponent {
	...
	updateAddressType = async ({ addressType = "legacy", rescanWallet = true } = {}) => {
		try {
	...
	requestHelp = () => {
		try {
			Linking.openURL("mailto:support@kronoswallet.org?subject=Requesting Some Help").catch((e) => console.log(e));
		} catch {}
	};

	visitWebsite = () => {
		try {
			Linking.openURL("https://kronoswallet.org").catch((e) => console.log(e));
		} catch {}
	};
