...
class TransactionDetail extends PureComponent {
	...
	openBlock = (block): void => {
		...
		if (selectedCrypto === "denarius") url = `https://chainz.cryptoid.info/d/block.dws?${block}`;
		if (selectedCrypto === "denariusTestnet") url = `https://chainz.cryptoid.info/d-test/block.dws?${block}`;
		openUrl(url);
	};
	...
	openAddress = (address = ""): void => {
		...
		if (selectedCrypto === "denarius") url = `https://chainz.cryptoid.info/d/address.dws?${address}`;
		if (selectedCrypto === "denariusTestnet") url = `https://chainz.cryptoid.info/d-test/address.dws?${address}`;
		openUrl(url);
	};
	...
	openMessage = (tx = ""): void => {
		...
		switch (selectedCrypto) {
			...
			case "litecoinTestnet":
				...
				break;
			case "denarius":
				url = `https://chainz.cryptoid.info/d/tx.dws?${tx}`;
				break;
			case "denariusTestnet":
				url = `https://chainz.cryptoid.info/d-test/tx.dws?${tx}`;
				break;
			default:
				return;
		}
