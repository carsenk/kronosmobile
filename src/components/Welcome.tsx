...
const updates = [
	...
	"First release of the Kronos Wallet for mobile"
];
	...
	return (
		<View style={styles.container}>
			...
			<View style={{ width: "85%" }}>
				...
				<Text
					onPress={() => Linking.openURL("mailto:support@kronoswallet.org?subject=Requesting Some Help").catch((e) => console.log(e))}
					style={[styles.text, { marginTop: 5 }]}
				>
					<Text style={styles.semiBoldText}>Email: </Text>support@kronoswallet.org
				</Text>
				<Text
					onPress={() => Linking.openURL("https://twitter.com/kronoswallet").catch((e) => console.log(e))}
					style={[styles.text, { marginTop: 5 }]}
				>
					<Text style={styles.semiBoldText}>Twitter: </Text>@kronoswallet
				</Text>
			</View>
