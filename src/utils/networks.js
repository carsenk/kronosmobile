...
const maxCoins = {
	...
	denarius: 1000000000000000,
	denariusTestnet: 1000000000000000
};
...
const getCoinImage = (coin = "bitcoin") => {
	try {
		...
		switch (coin) {
			...
			case "denarius":
				return require(`../assets/denarius.png`);
			default:
				return require(`../assets/bitcoin.png`);
		}
	} catch (e) {
	...
	try {
		...
		switch (selectedCrypto) {
			...
			case "denarius":
				satoshi = "denarii";
				oshi = "narii";
				acronym = cryptoUnit === "satoshi" ? "narii" : "D";
				blockTime = 0.5;
				return { acronym, label: "Denarius", crypto: "D", satoshi, oshi, blockTime };
			case "denariusTestnet":
				satoshi = "denarii";
				oshi = "narii";
				acronym = cryptoUnit === "satoshi" ? "narii" : "D";
				blockTime = 0.5;
				return { acronym, label: "Denarius Testnet", crypto: "D", satoshi, oshi, blockTime };
			default:
				acronym = cryptoUnit === "satoshi" ? "sats" : "BTC";
				return { acronym, label: "Bitcoin", crypto: "BTC", satoshi, oshi, blockTime };
		}
